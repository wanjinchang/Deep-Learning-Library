...
void imread_cifar(Mat &trainX, Mat &testX, Mat &trainY, Mat &testY){
    ...
    cout << mt1.rows << " " << mt1.cols << endl;
    cout << mt2.rows << " " << mt2.cols << endl;
